...
input : const skills = ["HTML","CSS","Javascript","React"]
output: 합격 
input:const skills = ["HTML","CSS","Javascript"] 
output: 예비 
input:const skills = ["HTML","CSS"] 
output: 탈락
*/

const skills = ["HTML", "CSS", "Javascript", "React"];
const javascript = skills.includes("Javascript");
const react = skills.includes("React");
